...
var (
	filter_HelloWorldService_Greating_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_HelloWorldService_Greating_0(ctx context.Context, marshaler runtime.Marshaler, client HelloWorldServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_HelloWorldService_Greating_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.Greating(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_HelloWorldService_Greating_0(ctx context.Context, marshaler runtime.Marshaler, server HelloWorldServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HelloWorldRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.Greating(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterHelloWorldServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HelloWorldServiceServer) error {
	...
	mux.Handle("GET", pattern_HelloWorldService_Greating_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_HelloWorldService_Greating_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_HelloWorldService_Greating_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterHelloWorldServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloWorldServiceClient) error {
	...
	mux.Handle("GET", pattern_HelloWorldService_Greating_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HelloWorldService_Greating_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_HelloWorldService_Greating_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"helloworld"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_HelloWorldService_Greating_0 = runtime.ForwardResponseMessage
)
